...
public class ListLinked<E> implements ListTAD<E> {
	...
	public void add(E e) {
		...
		// b) Apontar do �ltimo nodo da lista (tail) para o novo
		Node<E> t = tail;
		tail = newNode;
		// c) Aumentar o total de elementos em um (count)
		count++;
		// d) Agora, o �ltimo nodo passa a ser o novo
		if (t == null)
			head = newNode;
		else
			t.next = newNode;
	...
	public void add(int index, E element) {
		...
		//  b) Se a posi��o for inv�lida, gerar IndexOutOfBoundsException
		if (index < 0 || index > count) {
			throw new IndexOutOfBoundsException();
		}
		// TODO c) "Caminhar" at� a posi��o anterior � desejada (ant)
